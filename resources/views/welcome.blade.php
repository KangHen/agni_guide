...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Agni Guide</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />

        <!-- SEO Meta Tags -->
        <meta name="description" content="Agni Guide - Jelajah situs kota Tuban" />
        <meta name="author" content="Teropong Sejarah Tuban" />
    ...
    <div class="blur-2xl w-52 h-52 fixed inset-0 bg-white  pointer-events-none z-[-1]"></div>
    <header class="fixed w-full">
        <nav class="py-2.5">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto bg-gradient-to-r">
                <a href="/" class="flex items-center">
                    <img src="{{ asset('agni_1024.png') }}" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                </a>
        ...
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    <a href="#"
                       class="text-white inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center bg-red-500 rounded-lg sm:w-auto hover:bg-gray-100 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google-play" viewBox="0 0 16 16">
                            <path d="M14.222 9.374c1.037-.61 1.037-2.137 0-2.748L11.528 5.04 8.32 8l3.207 2.96zm-3.595 2.116L7.583 8.68 1.03 14.73c.201 1.029 1.36 1.61 2.303 1.055zM1 13.396V2.603L6.846 8zM1.03 1.27l6.553 6.05 3.044-2.81L3.333.215C2.39-.341 1.231.24 1.03 1.27"/>
                        </svg>
                        <span class="pl-2">PlayStore</span>
                    </a>
                    <a href="#"
                       class="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white rounded-lg sm:w-auto  hover:bg-red-500 hover:text-white focus:z-10">
                        ...
                        <span class="pl-2">AppStore</span>
                    </a>
                </div>
            </div>
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="{{ asset('hero/hero.webp') }}" class="rounded-full shadow-lg" alt="hero image">
            </div>
        </div>
    </section>
    <footer>
        <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-white">© {{ now()->format('Y') }}. All
                    Rights Reserved | Teropong Sejarah Tuban
                </span>
